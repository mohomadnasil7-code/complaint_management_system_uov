...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($password !== $confirm_password) {
        ...
        if ($check_result->num_rows > 0) {
            ...
            $insert_sql = "INSERT INTO users (username, password, email, full_name, user_type) 
                          VALUES (?, ?, ?, ?, 'admin')";
...
<body>
    ...
    <div class="container auth-container">
        <div class="auth-box">
            <h2 class="auth-title"><i class="fas fa-user-shield"></i> Admin Registration</h2>
            ...
            <div class="auth-links">
                ...
                <p>Are you a student? <a href="register.php">Student Registration</a></p>
            </div>
        </div>
    </div>
